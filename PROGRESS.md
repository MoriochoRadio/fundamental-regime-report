...
#### §5.10 self-learning chain 자산화 (4 사례 누적, 2026-05-22)
...
| **4호** | §5.10 본 절 (`docs/requirements.md` § 1 verbatim vs §7.7 (2) 충돌) | 박제 본문 명확성 의무 — §7.7 (1) 본문 확장 후속 |

4 사례 누적이 *다음 인수인계 자산*. 각각 다른 차원 (실행 검증 / 수치 stale /
self-defining / 박제 본문 명확성) 의 워크플로 한계를 정직 박제로 시연.
