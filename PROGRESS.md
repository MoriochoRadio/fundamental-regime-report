...
| D2 | 부실(라벨) 정의 | **α: 상폐 부실 합집합 B1' (drawdown 50% + 영업이익 음수 전환)** + β 학습 측 보완 | ✅ **확정 (2026-05-19)** — 양성 27 (8.4%), 0년 2 (2021, 2023), §5.5.7 |
