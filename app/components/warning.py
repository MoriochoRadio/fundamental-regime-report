...
# 한계 페이지 전체 본문 — 4 한계 항목 (docs §1.4 + 전환 빈도 추가, 일반인 친화)
_PAGE_INTRO = (
    "본 시스템은 *방법론과 데이터의 정직성 시연*용입니다. 다음 4 가지 한계를 명확히 안내합니다."
)
_PAGE_LIMITS = [
    (
        "1. 모델 위험 예측 정확도",
    ...
    (
        "3. 분석 범위",
        "분석 기간(2015–2024년) 중 한국 KOSPI200 에 속했던 기업만 분석합니다 "
        "(구성 변동·상장폐지 포함 321곳). 그 외 종목은 *데이터 없음* 으로 표시됩니다.",
    ),
    (
        "4. 시장 상태 전환 빈도",
        "시장 상태는 날마다 새로 계산되어 짧은 기간에 자주 바뀔 수 "
        "있습니다. 긴 추세 해석에는 주의가 필요합니다.",
    ),
]
